...
colr_button = tk.Button(controls_frame, text="change color" , command=change_pen_color)
clear_button = tk.Button(controls_frame, text="clear canvas" , command=lambda: canvas.delete("all"))

colr_button.pack(side="left", padx=5, pady=5)
...
line_width_slider = tk.Scale(controls_frame ,
